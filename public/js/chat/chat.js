$(document).ready(function(){
    var conversation1_id;
    var conversation2_id;
    show_conversations();
    ...
    $(document).delegate('.conversation-selected', 'click', function(e){//para el form creado dinamico
        ...
        conversation1_id=conversation_selected.data('id');
       $("#conversation_id").val(conversation1_id);
        var user1_id=$('#user1_id').val();
        var user1_accountname=$('#user1_accountname').val();
    ...
    function show_messages(){
        //alert('ahora deberian mostrarse los mensajes');
        //alert(conversation1_id);
        var dataString = {

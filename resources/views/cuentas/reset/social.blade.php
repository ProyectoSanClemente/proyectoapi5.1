...
<div class="container">
  @include('common.errors')
	<form method="post" id="form1" class="KT_tngformerror" action="http://reset.sanclemente.cl/sistemas/social/index.php" style="display:none">
    <table cellpadding="2" cellspacing="0" class="KT_tngtable">
      <tr>
        <td class="KT_th"><label for="kt_login_user">Cuenta de Usuario :</label></td>
